...
public class Menu {
    void attack(Player player1,Lands land1, Lands land2) {
        ...
        while ((land2.troopsonland > 0) && (land1.troopsonland > 1)) {
            ...
            if (land1.troopsonland >= 3 && land2.troopsonland >= 2) {
                ...
                if ((int) attacker_dices.get(2) <= (int) defender_dices.get(1)) {
                    land1.troopsonland--;
                    System.out.println("Attacker lost Remaining troopsonland :"+land1.troopsonland);
                }
                else {
                    land2.troopsonland--;
                    System.out.println("Defender lost Remaining troopsonland :"+land2.troopsonland);
                }
            ...
            if (land1.troopsonland == 2 && land2.troopsonland == 1) {
                ...
                if ((int) attacker_dices.get(1) <= (int) defender_dices.get(0)) {
                    ...
                    land2.troopsonland--;
                    System.out.println("Defender lost Remaining troopsonlandonland :"+land2.troopsonland);
                }
        ...
        if(land2.troopsonland==0) {
            ...
            System.out.println("Attacker Conquered "+land2.Landname);
        }
        else
            System.out.println("Attacker Failed to Conquer "+land2.Landname);
        }
        else
